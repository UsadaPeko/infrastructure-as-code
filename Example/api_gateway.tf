...
// Output
output "iac-api-gateway" {
  value       = "https://${aws_api_gateway_rest_api.iac-api-gateway.id}.execute-api.ap-northeast-2.amazonaws.com"
  description = "Infrastructure as Code - api_gateway.tf"
}
